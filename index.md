...
<div>
 <img src="/assets/dtwise-logo.png" style="width: 600px;" alt="DTwiSE" class="center"><br/>
</div>
...
<!--
	<div style="text-align: center;float:right;">
	 <form action="TODO" method="post" target="_blank"><button type="submit" class="button-submit">Submit your paper now!</button></form>
	 <br/>
	</div>
-->
</div>
...
Co-located with ICSE, the flagship conference of software engineering, DTwiSE intends to bring together software engineers, domain experts, modeling and simulation researchers, and practitioners.
The workshop will feature a keynote and peer-reviewed paper presentations with discussions. A closing interactive panel discussion will distill priority research questions, candidate artifacts, and collaboration opportunities into a concrete research agenda for DT software engineering.
